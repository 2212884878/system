					...
					<el-table-column label="操作" align="center">
						<el-table-column prop="" align="center">
							<template slot-scope="scope">
								<!-- <router-link :to="{path:'/Product',query:{id:scope.row.id,status:'del'}}">下架</router-link> -->
								<el-button size="mini" type="danger" @click="handleDelete(scope.row.id)">下架</el-button>
							</template>
						</el-table-column>
					</el-table-column>
				</el-table>
...
<script>
	...
	export default {
		...
		methods: {
			handleDelete(id) {//去产品详情
				this.$router.push({path:'/Product',query:{id:id,status:'del'}})
			},
			search() { //搜索
